...
import com.mumfrey.liteloader.debug.LoginManager;
...
public abstract class Start {
     ...
     */
    private static final Set<String> MULTI_VALUE_ARGS = ImmutableSet
            .<String> of("--tweakClass");
    ...
    private static String[] processArgs(String[] args) {
        ...
        Map<String, Set<String>> qualifiedArgs =
     ...
     * collections
     */
    private static void parseArgs(String[] args, List<String> unqualifiedArgs,
            Map<String, Set<String>> qualifiedArgs) {
    ...
    private static void
            addRequiredArgsClient(String[] args, List<String> unqualifiedArgs,
                    Map<String, Set<String>> qualifiedArgs) {
    ...
    private static void
            addRequiredArgsServer(String[] args, List<String> unqualifiedArgs,
                    Map<String, Set<String>> qualifiedArgs) {
        File gameDir = new File(System.getProperty("user.dir"));

        Start.addArg(qualifiedArgs,
                     "--tweakClass",
                     LiteLoaderTweakerServer.class.getName());
        Start.addArg(qualifiedArgs, "--version", "mcp");
        Start.addArg(qualifiedArgs, "--gameDir", gameDir.getAbsolutePath());
    }
    ...
    private static LoginManager doLogin(Map<String, Set<String>> qualifiedArgs) {
        File loginJson =
                new File(new File(System.getProperty("user.dir")), ".auth.json");
        ...
        loginManager.login(usernameFromCmdLine,
                           passwordFromCmdLine,
                           Start.LOGIN_RETRIES);

        LiteLoaderLogger.info("Launching game as %s",
                              loginManager.getProfileName());

        return loginManager;
    }

    private static void addArg(Map<String, Set<String>> qualifiedArgs,
    ...
    private static String getArg(Map<String, Set<String>> qualifiedArgs,
            String arg) {
    ...
    private static String[]
            combineArgs(String[] args, List<String> unqualifiedArgs,
                    Map<String, Set<String>> qualifiedArgs) {
